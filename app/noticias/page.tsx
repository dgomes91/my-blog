...
const noticias = ARTICLES.filter((a) => a.category === "noticias");
...
export default function NoticiasPage() {
  ...
  return (
    <main>
      ...
      {/* Featured article */}
      {featured && (
        <div className="relative w-full h-80 md:h-[440px] overflow-hidden group cursor-pointer">
          <img
