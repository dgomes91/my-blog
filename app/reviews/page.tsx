...
const reviews = ARTICLES.filter((a) => a.category === "reviews");
const featured = reviews[0]; // highest impact review as hero
...
export default function ReviewsPage() {
  ...
  const sorted = [...rest].sort((a, b) => {
    ...
    return 0; // recente: keep original order
  });
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_360px]">
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-3">
                    <span
                      className="text-[10px] font-bold tracking-widest bg-primary text-white px-2 py-0.5"
                  ...
                  <OswaldText
                    as="h2"
                    className="text-3xl md:text-5xl font-bold text-foreground leading-tight mb-3 group-hover:text-primary transition-colors"
                  >
                    {featured.title}
                  </OswaldText>
                      ...
                      <div className="flex gap-0.5 mb-1">
                        {Array.from({ length: 10 }).map((_, i) => (
                          <Star
                            key={i}
                            className={`w-3 h-3 ${
                              i < Math.round(featured.reviewScore ?? 0)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10">
          ...
          <aside className="space-y-8">
            ...
            <div>
              ...
              <div>
                {ARTICLES.filter((a) => a.category === "noticias").slice(0, 4).map((a) => (
